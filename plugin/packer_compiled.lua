...
local package_path_str = "/root/.cache/nvim/packer_hererocks/2.1.1692616192/share/lua/5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1692616192/share/lua/5.1/?/init.lua;/root/.cache/nvim/packer_hererocks/2.1.1692616192/lib/luarocks/rocks-5.1/?.lua;/root/.cache/nvim/packer_hererocks/2.1.1692616192/lib/luarocks/rocks-5.1/?/init.lua"
local install_cpath_pattern = "/root/.cache/nvim/packer_hererocks/2.1.1692616192/lib/lua/5.1/?.so"
...
_G.packer_plugins = {
  ["Abstract-cs"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/Abstract-cs",
  ...
  ["braceless.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/braceless.vim",
  ...
  ["indent-o-matic"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/indent-o-matic",
  ...
  ["mason-null-ls.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/mason-null-ls.nvim",
    url = "https://github.com/jay-babu/mason-null-ls.nvim"
  },
  ["mason-nvim-dap.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/mason-nvim-dap.nvim",
  ...
  ["nvim-toggler"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/nvim-toggler",
  ...
  ["omni.vim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/omni.vim",
  ...
  ["palenightfall.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/palenightfall.nvim",
    url = "https://github.com/JoosepAlviste/palenightfall.nvim"
  },
  penvim = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/penvim",
  ...
  ["telescope-dap.nvim"] = {
    loaded = true,
    path = "/root/.local/share/nvim/site/pack/packer/start/telescope-dap.nvim",
